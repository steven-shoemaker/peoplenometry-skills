...
# Still pending
Not yet canonical. Until an entry lands here, `/people-analytics` computes these with its method stated inline, flags "library entry pending," and — once you confirm the method — offers to save it as a Local metric in your house-rules. Guardrails noted are binding even while pending.
